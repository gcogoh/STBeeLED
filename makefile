...
#export PATH=$(PATH):$(TOOLDIR)/arm-gcc/bin;$(TOOLDIR)/bin;$(OCDIR);$(DFUDIR);$(MAKEDIR)
#export PATH=$(PATH):$(TOOLDIR)/bin:$(OCDIR):$(DFUDIR):$(MAKEDIR)
PROJ_DIR	= $(PWD)
...
#TOOLDIR = /opt/gcc-arm-none-eabi-4_6-2012q2/bin
#TOOLDIR = /opt/gcc-arm-none-eabi-5_4-2016q2/bin
 TOOLDIR = /opt/gcc-arm-none-eabi/bin
 OCDIR   = /usr/local/share/openocd
#OCDIR   = /opt/ARM/arm-linaro-eabi-4.6/share/openocd
 REMOVAL = rm
else ifeq ($(DEVTOOL),SUMMON)
 TOOLDIR = /opt/ARM/arm-linaro-eabi-4.6/bin
 OCDIR   = /usr/local/share/openocd
#OCDIR   = /opt/ARM/arm-linaro-eabi-4.6/share/openocd
 REMOVAL = rm
else ifeq ($(DEVTOOL),SOURCERY)
 TOOLDIR = /opt/Sourcery/arm-2011.09/bin
 OCDIR   = /usr/local/share/openocd
#OCDIR   = /opt/ARM/arm-linaro-eabi-4.6/share/openocd
 REMOVAL = rm
else
...
DFUDIR	= /opt/ST/DFUse/bin
		  
WSHELL  = 
MSGECHO = echo
GDBDIR  = /opt/Netx/arm-none-eabi-insight/bin
INSIGHT = $(GDBDIR)/$(TCHAIN)-insight
